            ...
            <div className="space-y-3">
              {creativeTools.map((tool) => {
                ...
                return (
                  <div
                    key={tool.name}
                    className="group bg-[#080808] border border-[#22252A] hover:border-[#F5A623]/40 rounded-[6px] p-3 sm:p-4 transition-all duration-200 flex items-center justify-between gap-3 sm:gap-4"
                  >
                    <div className="flex items-center gap-3 sm:gap-3.5 min-w-0">
                      <div className="w-8 sm:w-9 h-8 sm:h-9 rounded bg-[#0D0D0D] border border-[#22252A] flex items-center justify-center text-[#A7ADB7] group-hover:text-[#F5A623] group-hover:border-[#F5A623]/30 transition-colors flex-shrink-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="font-mono text-[10px] sm:text-[11px] text-[#6F7682] truncate">
                          {tool.role}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex-shrink-0 text-right">
                      <span className="font-mono text-[9px] sm:text-[10px] text-[#A7ADB7] bg-[#0D0D0D] px-1.5 sm:px-2 py-0.5 border border-[#22252A] rounded uppercase tracking-wider">
                        {tool.tag}
                      </span>
                    </div>
                  </div>
            ...
            <div className="space-y-3">
              {devTools.map((tool) => {
                ...
                return (
                  <div
                    key={tool.name}
                    className="group bg-[#080808] border border-[#22252A] hover:border-[#8FB8E8]/40 rounded-[6px] p-3 sm:p-4 transition-all duration-200 flex items-center justify-between gap-3 sm:gap-4"
                  >
                    <div className="flex items-center gap-3 sm:gap-3.5 min-w-0">
                      <div className="w-8 sm:w-9 h-8 sm:h-9 rounded bg-[#0D0D0D] border border-[#22252A] flex items-center justify-center text-[#A7ADB7] group-hover:text-[#8FB8E8] group-hover:border-[#8FB8E8]/30 transition-colors flex-shrink-0">
                        <Icon className="w-3.5 sm:w-4 h-3.5 sm:h-4" />
                      </div>
                      <div className="min-w-0">
                        <h4 className="font-heading font-bold text-sm sm:text-base text-[#F2F4F7] uppercase tracking-wide group-hover:text-[#FFFFFF] truncate">
