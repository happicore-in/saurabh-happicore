...
export const GraphicCTA: React.FC<GraphicCTAProps> = ({ onContactClick }) => {
  return (
    <div className="w-full my-16 bg-[#080808] border border-[#22252A] rounded-[8px] p-8 sm:p-12 lg:p-14">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        {/* Left Column: Heading & Text */}
        <div className="lg:col-span-8 space-y-3">
          <div className="inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.16em] text-[#8FB8E8]">
            <span>🎨</span>
            <span>NEED A DESIGN?</span>
          </div>
          ...
          <h2 className="font-heading font-extrabold text-3xl sm:text-4xl lg:text-5xl text-[#F2F4F7] uppercase tracking-tight leading-tight">
            LET&apos;S CREATE VISUALS THAT<br className="hidden sm:inline" /> COMMUNICATE CLEARLY AND STAND OUT.
          </h2>

          <p className="font-body text-sm sm:text-base text-[#A7ADB7] leading-relaxed max-w-xl">
            Available for event posters, tournament branding suites, social media campaign systems, and merchandise graphics.
          </p>
        </div>
        ...
        <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col items-start lg:items-end gap-3">
          ...
          <a
            href={`mailto:${IDENTITY.emailWork}?subject=Graphic%20Design%20Project%20Inquiry`}
